...
class CartaPublicaciones extends StatelessWidget {


  final M.PublicacionProducto producto;

  const CartaPublicaciones({this.producto});
    ...
    Widget CardProducto (){
     // DocumentSnapshot data = dataProducto.data();
      return  GestureDetector(
        onTap: (){
          Navigator.push(context, C.TransFade(page:  ProductoDetalle(producto: producto , fav: false,)));
        },
        child: Padding(
